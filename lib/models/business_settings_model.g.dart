...
BusinessSettingsModel _$BusinessSettingsModelFromJson(
    ...
    BusinessSettingsModel(
      ...
      requireHealthDisclosure: json['requireHealthDisclosure'] as bool?,
      requireRequiredAcknowledgments:
          json['requireRequiredAcknowledgments'] as bool?,
      requireTermsAndConditions: json['requireTermsAndConditions'] as bool?,
      requireCancellationPolicy: json['requireCancellationPolicy'] as bool?,
...
Map<String, dynamic> _$BusinessSettingsModelToJson(
    ...
    <String, dynamic>{
      ...
      'requireHealthDisclosure': instance.requireHealthDisclosure,
      'requireRequiredAcknowledgments': instance.requireRequiredAcknowledgments,
      'requireTermsAndConditions': instance.requireTermsAndConditions,
      'requireCancellationPolicy': instance.requireCancellationPolicy,
